            ...
            with gr.Row(visible=modules.config.default_image_prompt_checkbox) as image_input_panel:
                with gr.Tabs(selected=modules.config.default_selected_image_input_tab_id):
                    with gr.Tab(label='Upscale or Variation', id='uov_tab') as uov_tab:
                        with gr.Row():
                            ...
                            with gr.Column():
                                ...
                                gr.HTML('<a href="https://hisandher.online" target="_blank">\U0001F4D4 His and Her Fashion</a>')
                    with gr.Tab(label='Image Prompt', id='ip_tab') as ip_tab:
                        ...
                        gr.HTML('* \"Image Prompt\" is powered by His and Her Fashion Image Mixture Engine (v1.0.1). <a href="https://hisandher.online" target="_blank">\U0001F4D4 Documentation</a>')
                        ...
                        with gr.Row():
                            with gr.Column():
                                ...
                                example_inpaint_prompts = gr.Dataset(samples=modules.config.example_inpaint_prompts,
                                                                     ...
                                                                     visible=False)
                                gr.HTML('* Powered by Fooocus Inpaint Engine <a href="https://hisandher.online" target="_blank">\U0001F4D4 Documentation</a>')
                    ...
                    with gr.Tab(label='Describe', id='describe_tab') as describe_tab:
                        with gr.Row():
                            ...
                            with gr.Column():
                                ...
                                gr.HTML('<a href="https://hisandher.online" target="_blank">\U0001F4D4 Documentation</a>')
                    ...
                    with gr.Tab(label='Metadata', id='metadata_tab') as metadata_tab:
                        with gr.Column():
                            metadata_input_image = grh.Image(label='For images created by His and Her Fashion', source='upload', type='pil')
                ...
                with gr.Column(visible=modules.config.default_developer_debug_mode_checkbox) as dev_tools:
                    with gr.Tab(label='Debug Tools'):
                        ...
                        adaptive_cfg = gr.Slider(label='CFG Mimicking from TSNR', minimum=1.0, maximum=30.0, step=0.01,
                                                 ...
                                                 info='Enabling His and Her Fashion\'s implementation of CFG mimicking for TSNR '
                    ...
                    with gr.Tab(label='Inpaint'):
                        ...
                        inpaint_engine = gr.Dropdown(label='Inpaint Engine',
                                                     value=modules.config.default_inpaint_engine_version,
                                                     choices=flags.inpaint_engine_versions,
                                                     info='Version of His and Her Fashion inpaint model. If set, use performance Quality or Speed (no performance LoRAs) for best results.')
